...
func main() {
	...
	case "OpenSession":
		...
		err78 := argvalue0.Read(ctx, jsProt77)
		if err78 != nil {
			Usage()
			return
		}
	...
	case "CloseSession":
		...
		err84 := argvalue0.Read(ctx, jsProt83)
		if err84 != nil {
			Usage()
			return
		}
	...
	case "GetInfo":
		...
		err90 := argvalue0.Read(ctx, jsProt89)
		if err90 != nil {
			Usage()
			return
		}
	...
	case "ExecuteStatement":
		...
		err96 := argvalue0.Read(ctx, jsProt95)
		if err96 != nil {
			Usage()
			return
		}
	...
	case "GetTypeInfo":
		...
		err102 := argvalue0.Read(ctx, jsProt101)
		if err102 != nil {
			Usage()
			return
		}
	...
	case "GetCatalogs":
		...
		err108 := argvalue0.Read(ctx, jsProt107)
		if err108 != nil {
			Usage()
			return
		}
	...
	case "GetSchemas":
		...
		err114 := argvalue0.Read(ctx, jsProt113)
		if err114 != nil {
			Usage()
			return
		}
	...
	case "GetTables":
		...
		err120 := argvalue0.Read(ctx, jsProt119)
		if err120 != nil {
			Usage()
			return
		}
	...
	case "GetTableTypes":
		...
		err126 := argvalue0.Read(ctx, jsProt125)
		if err126 != nil {
			Usage()
			return
		}
	...
	case "GetColumns":
		...
		err132 := argvalue0.Read(ctx, jsProt131)
		if err132 != nil {
			Usage()
			return
		}
	...
	case "GetFunctions":
		...
		err138 := argvalue0.Read(ctx, jsProt137)
		if err138 != nil {
			Usage()
			return
		}
	...
	case "GetPrimaryKeys":
		...
		err144 := argvalue0.Read(ctx, jsProt143)
		if err144 != nil {
			Usage()
			return
		}
	...
	case "GetCrossReference":
		...
		err150 := argvalue0.Read(ctx, jsProt149)
		if err150 != nil {
			Usage()
			return
		}
	...
	case "GetOperationStatus":
		...
		err156 := argvalue0.Read(ctx, jsProt155)
		if err156 != nil {
			Usage()
			return
		}
	...
	case "CancelOperation":
		...
		err162 := argvalue0.Read(ctx, jsProt161)
		if err162 != nil {
			Usage()
			return
		}
	...
	case "CloseOperation":
		...
		err168 := argvalue0.Read(ctx, jsProt167)
		if err168 != nil {
			Usage()
			return
		}
	...
	case "GetResultSetMetadata":
		...
		err174 := argvalue0.Read(ctx, jsProt173)
		if err174 != nil {
			Usage()
			return
		}
	...
	case "FetchResults":
		...
		err180 := argvalue0.Read(ctx, jsProt179)
		if err180 != nil {
			Usage()
			return
		}
	...
	case "GetDelegationToken":
		...
		err186 := argvalue0.Read(ctx, jsProt185)
		if err186 != nil {
			Usage()
			return
		}
	...
	case "CancelDelegationToken":
		...
		err192 := argvalue0.Read(ctx, jsProt191)
		if err192 != nil {
			Usage()
			return
		}
	...
	case "RenewDelegationToken":
		...
		err198 := argvalue0.Read(ctx, jsProt197)
		if err198 != nil {
			Usage()
			return
		}
